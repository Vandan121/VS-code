...
ll binaryMultiply(ll a, ll b, ll M = mod)
{
    ll ans = 0;
    while (b)
    {
...
ll binaryExponentiation(ll a, ll b, ll M = mod)
{
    a %= M;
    ll ans = 1;
    while (b)
