...
int main()
{
    ...
    cin>>s;
        int numb = 1,lc = 1,uc = 1, scs= 1,temp = 1;
        size_t found;
        loop(i,0,n)
        {
            temp = 1;
            ...
            if(scs && temp)
            {
                found = special_characters.find(s[i]);
                if(found != string::npos)
                {
                    temp =0;
                    scs=0;
