...
void solve()
{
    ll n; cin>>n;
    vector<pl> coor(3);
    cin>>coor[0].fr>>coor[0].sc; 
    cin>>coor[1].fr>>coor[1].sc; 
    cin>>coor[2].fr>>coor[2].sc;
    ll x,y; cin>>x>>y;
    ll row;
    ll col;
    if(coor[0].fr == coor[1].fr){
        row = coor[0].fr;
        col = coor[2].sc;
    } 
    else if(coor[0].fr == coor[2].fr){
        row = coor[0].fr;
        col = coor[1].sc;
    } 
    else{
    ...
    if((row == 1 && col == n) || (row == 1 && col == 1) || (row == n && col == n) || (row == n && col == 1)){
        if(x == row || y == col){
            cout<<"YES"<<endl;
        }
        else{
    ...
    if(abs(row-x)%2 == 0 || abs(col-y)%2 == 0){
        cout<<"YES"<<endl;
    } 
    else{
        cout<<"NO"<<endl;
