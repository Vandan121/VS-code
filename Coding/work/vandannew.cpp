...
//         {
//             writehtml3 << "<span class=\"dotgreen\">" << clg[x].branch1[i] << "</span>&nbsp&nbsp" << endl;
//         }
...
//             {
//                 writehtml3 << "<span class=\"dotred\">&nbsp&nbsp</span> &nbsp&nbsp" << endl;
//             }
//         }
//         writehtml3 << "</div>" << endl;
//         writehtml3 << "<br>";
...
//         {
//             writehtml3 << "<span class=\"dotgreen\">" << clg[x].branch2[m] << "</span>&nbsp&nbsp" << endl;
//         }
//         if (m != clg[x].b[1] - 1)
//         {
...
//         {
//             writehtml3 << "<span class=\"dotgreen\">" << clg[x].branch3[n] << "</span>&nbsp&nbsp" << endl;
//         }
//         if (n != clg[x].b[2] - 1)
//         {
