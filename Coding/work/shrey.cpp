...
void collegedata(int round)
{
    int i;
    ofstream writehtml2;
    writehtml2.open("Collegedata.html",ios::app);
       if(round==1)
       {
        writehtml2 << "<!DOCTYPE html>" << endl
              << "<html lang=\"en\">" << endl
       ...
       if(round<4)
       {
           writehtml2<<"<p style=\" text-align: center; vertical-align: middle; line-height: 20px; background-color: #EBFE00\">"<<endl;
            writehtml2<< "<h2>ROUND - "<<round<<"</h2>"<<endl
                      <<"</p>"<<endl;
       }
       else
       {
           writehtml2<<"<p style=\" text-align: center; vertical-align: middle; line-height: 20px; background-color: #EBFE00\">"<<endl;
            writehtml2<< "<h2>FINAL ROUND</h2"<<endl
                      <<"</p>"<<endl;
       }
    
    writehtml2 << "//////////////////////////////////////////////////////////////////" << endl;
    writehtml2 << "////                                                           ///" << endl;
    writehtml2 << "////                         ROUND                             ///" << endl;
    writehtml2 << "////                                                           ///" << endl;
    writehtml2 << "//////////////////////////////////////////////////////////////////" << endl;
    int a=0;
    for (int x = 0; x < 10; x++)
    {
        writehtml2<<"<div class=\"demo"<<a%5 + 1<<"\">"<<endl
                <<"<h2>";
        writehtml2 << colleges[x] << "<br>"<<endl
                   << "Computer Science : " << clg[x].b[0] << "<br>"<<endl;
        for (i = 0; i < clg[x].branch1.size(); i++)
        {
            writehtml2 << clg[x].branch1[i] << " ";
        }
        if (i != clg[x].b[0] - 1)
        {
        ...
        writehtml2 << "<br>"<<endl;
        writehtml2 << "Mechanical : " << clg[x].b[1] << "<br>"<<endl;
        for (i = 0; i < clg[x].branch2.size(); i++)
        {
            writehtml2 << clg[x].branch2[i] << " ";
        }
        if (i != clg[x].b[1] - 1)
        {
        ...
        writehtml2 << "<br>"<<endl;
        writehtml2 << "Electrical : " << clg[x].b[2] << "<br>"<<endl;
        for (i = 0; i < clg[x].branch3.size(); i++)
        {
            writehtml2 << clg[x].branch3[i] << " ";
        }
        if (i != clg[x].b[2] - 1)
        {
