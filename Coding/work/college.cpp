...
public:
    ...
    void check()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            {
                if (clg[one - 1].branch1.size() < clg[one - 1].b[1])
                {
                    clg1 = choices[i];
                    clg[one - 1].branch1.push_back(rank);
                    break;
            ...
            {
                if (clg[one - 1].branch1.size() < clg[one - 1].b[2])
                {
                    clg1 = choices[i];
                    clg[one - 1].branch1.push_back(rank);
                    break;
...
int main()
{
    ...
    colleges.push_back("A");
    colleges.push_back("B");
    colleges.push_back("C");
    colleges.push_back("D");
    colleges.push_back("E");
    colleges.push_back("F");
    colleges.push_back("G");
    colleges.push_back("H");
    colleges.push_back("I");
    colleges.push_back("J");
