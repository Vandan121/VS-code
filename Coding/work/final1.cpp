...
int main()
{
    ...
    writehtml << "<!DOCTYPE html>" << endl
              ...
              << "<style>" << endl
              << ".demo1 {" << endl
              << "background-color: #F7D9D7" << endl
              << "}" << endl
              << ".demo2 {" << endl
              << "background-color: #F7F5D7" << endl
              << "}" << endl
              << ".demo3 {" << endl
              << "background-color: #D7F7E7" << endl
              << "}" << endl
              << ".demo4 {" << endl
              << "background-color: #D7E9F7" << endl
              << "}" << endl
              << ".demo5 {" << endl
              << "background-color: #F7D7ED" << endl
              << "}" << endl
              << "</style>" << endl;
    ...
    ShellExecute(NULL, "open", "Ranks.html",
