...
class Solution
{
    ...
    { 
        ...
        node* ret_head=NULL,*ret_tail=NULL,*cur=head,*temp_head=head,*temp_tail=head;
        while(cur){
            int size=1;
            temp_head = NULL;
            temp_tail = NULL;
            ...
            if(!ret_head)
            {
                ret_head = temp_head,ret_tail=temp_tail;
                temp_tail->next = NULL;
            } 
            else ret_tail->next = temp_head,ret_tail = temp_tail;
        }
        ret_tail->next = NULL;
        return ret_head;
    }
